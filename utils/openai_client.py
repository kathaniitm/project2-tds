    ...
    functions = [
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Write documentation in Markdown for a topic where markdown should include certain elements.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "topic": {
                            "type": "string",
                            "description": "Write documentation in Markdown for an",
                        },
                        "elements": {
                            "type": "array",
                            "items": {"type": "string"},
        ...
        },
        {
            ...
            "function": {
                "name": "run_colab_code",
                "description": "Run this program on Google Colab, allowing all required access to your email ID",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "code": {
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "OpenAI's API to analyze the sentiment of this (meaningless) text into GOOD, BAD or NEUTRAL. One of the test cases involves sending a sample piece of meaningless text:",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "user_text": {
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Your task is to write a Python function that will calculate the cosine similarity between each pair of these embeddings and return the pair that has the highest similarity. The result should be a tuple of the two phrases that are most similar.",
                "parameters": {
                    "type": "object",
                    "properties": {
                    },
        ...
        },
        {
            "type": "function",
            "function": {
                "name": "create_embedding_payload",
                "description": "JSON body for a POST request that will be sent to the OpenAI API endpoint to obtain the text embedding for the 2 given personalized transaction verification messages above.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "text1": {
                            "type": "string",
                            "description": "verification message 1",
                        },
                        "text2": {
                            "type": "string",
                            "description": "verification message 2",
                        },
                    },
        ...
        },
        {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "addresses": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "which is an array of objects with required fields",
                        },
                    },
                    "required": ["prompt"],
                },
            ...
            "type": "function",
            "function": {
                "name": "generate_structured_json_image",
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "What is the maximum latitude of the bounding box of the city",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "city": {
        ...
        },
         {
            "type": "function",
            "function": {
                "name": "get_latest_hn_post_link",
                "description": "What is the link to the latest Hacker News post mentioning keyword with minmum points",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "keyword": {
                            "type": "string",
                            "description": "keyword or word that needs to be searched",
                        },
                        "min_points": {
                            "type": "string",
                            "description": "miniumn points required",
                        },
                    },
            ...
            "type": "function",
            "function": {
                "name": "get_newest_user_creation_date",
                ...
                "parameters": {
                    ...
                    "properties": {
                        "city": {
                            "type": "string",
                            "description": "user located in the city",
                        },
                        "min_followers": {
                            "type": "string",
                            "description": "miniumn number of followers for the user",
                        },
                    },
                    "required": ["city","min_followers"],
                },
            },
        },
        {
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Extract tables from a PDF file and calculate the total marks in a subject of students who scored marks x or more marks in a subject and are in groups min_group to max_group (inclusive)",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "file_path": {
                        ...
                        "subject1": {
                            "type": "string",
                            "description": "total marks in subject",
                        },
                        "subject2": {
                            "type": "string",
                            "description": "subject with minumn marks requirement",
                        },
                        "min_marks": {
                            "type": "string",
                            "description": "minumn marks",
                        },
                        "min_group": {
                            "type": "string",
            ...
            for tool_call in message["tool_calls"]:
                ...
                if function_name == "execute_command":
                    ...
                    answer = await analyze_sentiment(
                        user_text=function_args.get("user_text"),
                ...
                elif function_name == "topic_modelling":
                    answer = await topic_modelling()
                elif function_name == "create_embedding_payload":
                    answer = await create_embedding_payload(
                        text1= function_args.get("text1"),
                        text2= function_args.get("text2"),
                    )
                ...
                elif function_name == "generate_structured_json_image":
                    answer = await generate_structured_json_image(
                        image_path=function_args.get("file_path"),
                    )
                    ...
                    answer = await get_max_latitude(
                        city=function_args.get("city"),
                        country=function_args.get("country")
                    )
                elif function_name == "get_latest_hn_post_link":
                    answer = await get_latest_hn_post_link(
                        keyword=function_args.get("keyword"),
                        min_points=function_args.get("min_points")
                    )
                elif function_name == "get_newest_user_creation_date":
                    answer = await get_newest_user_creation_date(
                        city=function_args.get("city"),
                    ...
                    answer = await extract_tables_from_pdf(
                        ...
                        subject1=function_args.get("subject1"),
                        subject2=function_args.get("subject2"),
                        min_marks=function_args.get("min_marks"),
                        min_group=function_args.get("min_group"),
                        max_group=function_args.get("max_group"),
                    )
                    ...
                    post_id_column=function_args.get("post_id_column"),
                    timestamp_column=function_args.get("timestamp_filter"),
                    useful_star_threshold=function_args.get("useful_star_threshold"),
